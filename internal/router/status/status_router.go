...
import (
	present "fms/internal/presenter/status"
...
func GetRouter(router *gin.Engine, db *gorm.DB) *gin.Engine {
	...
	webV1 := router.Group("fms").Group("web").Group("v1.0").Group("statuses")
	{
	...
	appV1 := router.Group("fms").Group("app").Group("v1.0").Group("statuses")
	{
