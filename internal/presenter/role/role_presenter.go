...
import (
	...
	"fms/internal/interactor/manager/role"
...
// @Router /web/v1.0/roles [post]
// @Router /app/v1.0/roles [post]
...
// @failure 415 object code.ErrorMessage{detailed=string} "必要欄位帶入錯誤"
// @failure 500 object code.ErrorMessage{detailed=string} "伺服器非預期錯誤"
// @Router /web/v1.0/roles [get]
// @Router /app/v1.0/roles [get]
...
// @failure 415 object code.ErrorMessage{detailed=string} "必要欄位帶入錯誤"
// @failure 500 object code.ErrorMessage{detailed=string} "伺服器非預期錯誤"
// @Router /web/v1.0/roles/{id} [get]
// @Router /app/v1.0/roles/{id} [get]
...
// @failure 415 object code.ErrorMessage{detailed=string} "必要欄位帶入錯誤"
// @failure 500 object code.ErrorMessage{detailed=string} "伺服器非預期錯誤"
// @Router /web/v1.0/roles/{id} [delete]
// @Router /app/v1.0/roles/{id} [delete]
...
// @failure 415 object code.ErrorMessage{detailed=string} "必要欄位帶入錯誤"
// @failure 500 object code.ErrorMessage{detailed=string} "伺服器非預期錯誤"
// @Router /web/v1.0/roles/{id} [patch]
// @Router /app/v1.0/roles/{id} [patch]
