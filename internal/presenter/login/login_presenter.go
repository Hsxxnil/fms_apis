...
import (
	...
	"fms/internal/interactor/manager/login"
	jwxModel "fms/internal/interactor/models/jwx"
	loginModel "fms/internal/interactor/models/logins"
...
// @Router /web/v1.0/login [post]
// @Router /app/v1.0/login [post]
...
// @failure 415 object code.ErrorMessage{detailed=string} "必要欄位帶入錯誤"
// @failure 500 object code.ErrorMessage{detailed=string} "伺服器非預期錯誤"
// @Router /web/v1.0/refresh [post]
// @Router /app/v1.0/refresh [post]
