...
import (
	...
	model "fms/internal/entity/postgresql/db/drivers"
...
func (s *storage) Update(input *model.Base) (err error) {
	...
	if input.IDCardNumber != nil {
		data["id_card_number"] = input.IDCardNumber
	}

	if input.EmployeeNumber != nil {
		data["employee_number"] = input.EmployeeNumber
	}
